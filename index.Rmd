...
knitr::opts_chunk$set(include = F, warning = F, message = F, fig.showtext=TRUE)
...
```{r}
write_csv(all, "data-web/dane_inkaso_vse.csv")
```
...
```{r}
write_csv(all_diffs, "data-web/dane_inkaso_mezirocni.csv")
```
